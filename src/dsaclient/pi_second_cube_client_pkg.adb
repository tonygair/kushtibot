...
package body  Pi_Second_Cube_Client_Pkg is
...
--     end Data_Received;
   ...
   procedure Process_Waiting_Local_Messages_From_Cube
     (Client : in out GNAT.Sockets.Connection_State_Machine.ELV_MAX_Cube_Client.ELV_MAX_Cube_Client) is
...
--     end Disconnected;
   ...
   begin
      ...
      Set
        (  Reference,
           new GNAT.Sockets.Connection_State_Machine.ELV_MAX_Cube_Client.ELV_MAX_Cube_Client
      ...
      declare
         Client : GNAT.Sockets.Connection_State_Machine.ELV_MAX_Cube_Client.ELV_MAX_Cube_Client renames
           GNAT.Sockets.Connection_State_Machine.ELV_MAX_Cube_Client.ELV_MAX_Cube_Client (Ptr (Reference).all);
      begin
         ...
         begin
            ...
            loop
               if Terminate_The_Task then
                  ...
                  Refresh_Tardy_Devices(Client            => Client,
                                        Max_Device_Number => Number_Of_Devices );
                  delay 50.0;
